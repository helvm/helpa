module HelVM.HelPA.Assemblers.SQA.Reducer where

import           HelVM.HelPA.Assemblers.SQA.Instruction

import           HelVM.HelPA.Assemblers.ASQ.API.QuestionMark

import qualified HelVM.HelPA.Assemblers.ASQ.Instruction      as ASQ
import qualified HelVM.HelPA.Assemblers.ASQ.Reducer          as ASQ
...
reduceLabel l = ASQ.makeDataInstruction [ASQ.makeItemFromIdentifier l]
